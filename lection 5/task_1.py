...
def letter_stat(our_str):
    """
    Функция для подсчета повторяющихся букв в строке.
    :param our_str: Получаем строку в которой нужно подсчитать количество повторяющихся символов.
    :return: Возвращаем словарь, где ключ это буква, а значение - число повторений буквы в строке.
    """
