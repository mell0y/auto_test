...
def segment(*tpl):
    """
    Функция на вход принимает 2 кортежа с цифрами являющиеся координатами точек и возвращает сумму всех координат,
    При возникновении исключения обрабатывает его и возвращает перевернутый текст исключения.
